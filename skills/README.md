...
**数据源：** QVeris API + finance-data + akshare + 富途 OpenD（多数据源支持）

---

**原名：** 炒股 Agent 团队  
**更名日期：** 2026-03-23  
**说明：** "股票投资团队"更准确反映团队职责 - 不仅是炒股，更是系统化的投资分析
...
| 角色 | Agent 名称 | 职责 | 触发条件 |
|------|-----------|------|----------|
| 📡 数据收集员 | `data-collector` | 获取实时股价、大盘指数、市场新闻、财报数据 | 定时/手动 |
...
| 功能 | 说明 | 数据源 |
|------|------|--------|
| **指数行情** | A 股/港股主要指数实时数据 | QVeris/同花顺 iFinD |
| **资金流向** | 行业板块资金流入/流出 | QVeris/同花顺 iFinD |
| **财经新闻** | 全球财经新闻聚合 | QVeris/Finnhub |
| **创新高股票** | 当日创新高股票列表 | QVeris |
...
# 输出：data/market_data_YYYY-MM-DD_HH-MM.json
```

### 详细文档

- [QVERIS_INTEGRATION.md](QVERIS_INTEGRATION.md) - 整合指南
- [data-collector/SKILL.md](data-collector/SKILL.md) - 数据收集员规范（已更新）
...
| 日期 | 变更 |
|------|------|
| 2026-03-23 | "炒股 Agent 团队" → "股票投资团队" |

---

*最后更新：2026-03-23*  
*版本：v1.1（QVeris 整合 + 团队更名）*
