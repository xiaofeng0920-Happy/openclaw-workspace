...
def get_history_order_fill_list(start=None, end=None, acc_id=None, market=None, trd_env=None, output_json=False):
    ...
    ctx = None
    try:
        ctx = create_trade_context(trd_market)
...
if __name__ == "__main__":
    ...
    get_history_order_fill_list(start=args.start, end=args.end, acc_id=args.acc_id, market=args.market, trd_env=args.trd_env, output_json=args.output_json)
