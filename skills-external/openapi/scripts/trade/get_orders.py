...
def get_orders(acc_id=None, market=None, trd_env=None, output_json=False):
...
if __name__ == "__main__":
    ...
    get_orders(acc_id=args.acc_id, market=args.market, trd_env=args.trd_env, output_json=args.output_json)
